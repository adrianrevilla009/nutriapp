...
schemas across service boundaries") -- identity-service and profile-service
each own an identical but independent copy.
"""
...
class DomainEvent:
    ...
    def handler_method_suffix(self) -> str:
        """snake_case rendering of event_type (e.g. "FoodEntryLogged" ->
        "food_entry_logged") -- aggregates' apply() dispatch uses this to
