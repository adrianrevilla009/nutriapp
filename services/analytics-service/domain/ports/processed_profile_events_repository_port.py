"""ProcessedProfileEventsRepositoryPort -- idempotency dedup ledger
for the profile-events consumer, keyed by `event_id` alone. One
...
class ProcessedProfileEventsRepositoryPort(Protocol):
