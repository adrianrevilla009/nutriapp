...
real Postgres instances scoped to the test session"). This service has no
Redis dependency (no caching in this plan's scope)."""
...
async def db_engine(postgres_async_url):
    ...
    # per test by default -- mirrors every other service's identical
    # conftest.py precedent.
