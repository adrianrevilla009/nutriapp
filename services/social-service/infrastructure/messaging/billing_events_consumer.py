...
retried forever or dropped silently. Mirrors recipe-service's
`billing_events_consumer.py` exactly."""
...
async def dispatch_billing_event(
    ...
    as a standalone function (mirrors recipe-service's/notification-service's
