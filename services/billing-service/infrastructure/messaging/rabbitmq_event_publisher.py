...
topic exchange per producing service (`billing.events`).
"""
...
_ROUTING_KEYS: dict[str, str] = {
    ...
    "SubscriptionPaymentFailed": "billing.subscription.payment_failed",
    "EntitlementGranted": "billing.entitlement.granted",
    "EntitlementRevoked": "billing.entitlement.revoked",
}


def routing_key_for(event_type: str) -> str:
    return _ROUTING_KEYS.get(event_type, f"billing.subscription.{event_type.lower()}")
