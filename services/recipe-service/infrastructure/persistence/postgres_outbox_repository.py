"""PostgresOutboxRepository -- implements OutboxRepositoryPort. Mirrors
services/billing-service's adapter exactly (messaging-conventions
SKILL.md's Outbox Pattern relay is a repo-wide convention)."""
